...
def getDefinitions(letter):
    ...
    char_list = [char for char in letter]
    ...
    for char in char_list: 
        ...
        try: 
            ...
            print('Character entered is not readable.')
...
No terms under this letter - z. 
        ...
        print(switcher.get(char,"Invalid: {}".format(char)))
...
def getStateVarCodes(): 
    ...
    var_list = ['Unemployment Rate', 'Nominal GDP', 'Real GDP', 'Nominal Private Goods GDP', 
                ...
                'Nominal Government GDP', 'Real Government GDP', 'Estimated Median Household Income', 
                'Wages', 'Income Inequality', 
                'Personal Income', 'Per Capita Personal Income', 'Median House Prices', 
                'Average House Prices', 'Median Price Per Square Foot', 'Median Square Footage', 
                'New Listings', 'Active Listings', 'Pending Listings', 'New House Authorized Building Permits', 
                'Home Ownership Rate', 'Market Hotness Rank', 'SNAP Benefits Recipients', 
                'Poverty Rate (All Ages)', 'Subprime Credit Population Rate', 'Child Poverty Rate', 
                'Related Child Poverty Rate', 'Burdened Households Rate', 'High School Graduation Rate', 
                "Bachelor's Degree Rate", "Associate's Degree Rate (Ages 25+)", 'Disconnected Youth Rate', 
                ...
                'Average Hourly Earnings', 'Nonperforming Loans Ratio', 'Commercial Banks', 
                'Real Estate Earnings', 'Bank Assets', 'Government Employees', 'Net Loan Losses Rate', 
                'Return on Average Bank Equity', 'Allocated Transfer Risk Reserves', 'Discouraged Workers', 
                'Median Days on the Market', 'Total Held-To-Maturity Securities', 'Net Bank Income', 
                ...
                'Preventable Hospital Admissions Rate', 'Total Taxes', 'Net Corporation Taxes', 'Motor Fuel Taxes', 
                ...
                'Tobacco Sales Taxes', 'Corporate License Taxes', 'Fair / Poor Health', 'Medically Uninsured Rate', 
                'Smoking Rate', 'Obesity Rate', 'Excessive Drinking Rate', 'Motor Vehicle Mortality Rate', 'Teen Birth Rate', 
                'Primary Care Physician Rate', 'Mammogram Rate', 'Low Birthweight Rate', 'Mental Health Provider Rate', 'Percent Diabetic', 
                'Percent Physically Inactive', 'HIV Rate', 'Hispanic', 'Not Hispanic', 'Health Care Assistance Earnings', 
                'Employment Level', 'Civilian Labor Force', 'White - Not Hispanic', 'Black - Not Hispanic', 
                'Native Indian Or Alaska - Not Hispanic', 'Asian - Not Hispanic', 'Native Hawaiian - Not Hispanic', 
                'Other - Not Hispanic', 'Two Or More Races - Not Hispanic', 'Two Races Including Some Other Race - Not Hispanic', 
                'White - Hispanic', 'Black - Hispanic', 'Native Indian Or Alaska - Hispanic', 'Asian - Hispanic', 
                'Native Hawaiian - Hispanic', 'Other - Hispanic', 'Two Or More Races - Hispanic', 
                'Two Races Including Some Other Race - Hispanic', 'Precipitation', 'Average Temperature', 
                'Maximum Temperature', 'Minimum Temperature', 'Retail And Recreation Mobility Concentration', 
                'Grocery And Pharmacy Mobility Concentration', 'Parks Mobility Concentration', 
                'Transit Stations Mobility Concentration', 'Workplaces Mobility Concentration', 'Residential Mobility Concentration', 
                'One Year Municipal Bond Yield Rate', 
                'Two Year Municipal Bond Yield Rate', 'Three Year Municipal Bond Yield Rate', 
                'Five Year Municipal Bond Yield Rate', 'Ten Year Municipal Bond Yield Rate', 
                'Fifteen Year Municipal Bond Yield Rate', 'Twenty Year Municipal Bond Yield Rate', 
                'Twenty-Five Year Municipal Bond Yield Rate', 'COVID-19 Cases', 'COVID-19 Deaths']
...
def getUSVarCodes():
    ...
    var_list = ['Federal Funds Rate', 'Ice BofA High Yield Index', 'US / Euro Exchange Rate', 
                'S&P 500', 'Dow Jones Industrial', 'China / US Exchange Rate', 'Japan / US Exchange Rate', 
                'Bank Prime Rate', 
                'Primary Credit Rate', 'Bank Deposits', 'Bank Liabilities', 'Inflation Rate', 
                'Financial Stress Index', 'Discount Rate', 'Three Month Libor Rate', 'One Year Libor Rate', 
                'Overnight Bank Funding Rate', 'Secured Overnight Financing Rate', 'M1 Money Stock', 'M2 Money Stock', 
                'Commercial Paper', 
                'Velocity of Money Stock', 'Litecoin', 'Nikkei 225', 'Wilshire 5000', 'NASDAQ', 
                'Bitcoin', 'Ethereum', 'Six Month High Quality Market Corporate Bond Spot Rate', 
                'One Year High Quality Market Corporate Bond Spot Rate', 'Two Year High Quality Market Corporate Bond Spot Rate', 
                'Five Year High Quality Market Corporate Bond Spot Rate', 'Ten Year High Quality Market Corporate Bond Spot Rate', 
                'Thirty Year High Quality Market Corporate Bond Spot Rate', 'Fifty Year High Quality Market Corporate Bond Spot Rate', 
                'One Hundred Year High Quality Market Corporate Bond Spot Ratet', 'One Month Treasury Bill Yield Rate', 'Three Month Treasury Bill Yield Rate', 
                'Six Month Treasury Bill Yield Rate', 'One Year Treasury Bond Yield Rate', 'Two Year Treasury Bond Yield Rate', 
                'Three Year Treasury Bond Yield Rate', 'Five Year Treasury Bond Yield Rate', 'Seven Year Treasury Bond Yield Rate', 
                'Ten Year Treasury Bond Yield Rate', 'Twenty Year Treasury Bond Yield Rate', 'Thirty Year Treasury Bond Yield Rate', 
                'Venezuela / US Exchange Rate', 'South Africa / US Exchange Rate', 'South Korea / US Exchange Rate', 
                'Sweden / US Exchange Rate', 'Switzerland / US Exchange Rate', 'Hong Kong / US Exchange Rate', 
                'Mexico / US Exchange Rate', 'Canada / US Exchange Rate', 'US / Australia Exchange Rate', 'US / Uk Exchange Rate', 
                'Singapore / US Exchange Rate', 'India / US Exchange Rate', 'Brazil / US Exchange Rate', 'Diesel Gas Price Per Gallon', 
                'Regular Gas Price Per Gallon', 'Natural Gas Consumption', 'Fifteen Year Fixed Mortgage Rate', 
                'Thirty Year Fixed Mortgage Rate', 'Single-Family Home Delinquency Rate', 'Five-One Year Ajustable Mortgage Rate', 
                'Total Business Sales', 'Total Retail Food Sales', 'Restaurant Sales', 'Clothing Sales', 
                ...
                'Recreation Sales', 'General Merchandise Sales', 'Miscellaneous Store Sales', 'Nonstore Retail Sales', 
                'One Week Libor Rate', 'COVID-19 Recoveries']
...
def getStateData(state_code, var_code):
    ...
    try:
        ...
        print('One of the codes not qualified.  Please select an acceptable code.  Call getStateVarCodes() and/or getStateCodes() to see the dictionary of states variables and/or state codes.')
...
def getUSData(var_code):
    ...
    try: 
        ...
        return print('Code not qualified.  Please select an acceptable code.  Call getUSVarCodes() to see the dictionary of US variables.')
